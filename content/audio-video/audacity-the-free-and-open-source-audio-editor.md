...
- [**LMMS**](https://getfoss.org/audio-video/lmms-cross-platform-digital-audio-workstation-for-music-production/)**:** Designed for music production rather than general audio editing. Includes built-in instruments and sequencers.
