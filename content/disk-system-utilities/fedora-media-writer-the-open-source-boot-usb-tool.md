...
<li><strong><span style="color: #e03e2d;"><a href="https://getfoss.org/diy-advanced/popsicle-parallel-usb-flashing-utility/" target="_blank" rel="noopener" style="color: #e03e2d;">Popsicle</a></span>:</strong> A lightweight GTK-based USB flasher created by the Pop!_OS team. Great for Linux users who want a simple, native flashing tool without the Qt dependencies of Fedora Media Writer.</li>
</ul>
